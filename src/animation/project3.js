const images = importAll(require.context('../images/project3', false, /\.(png|jpe?g|svg)$/)); //project2
...
//
function pro3(){
    const div = document.getElementById('project3-2'); //scroll container
    const canvas = document.getElementById("pCards-container3-2"); //canvas for image container
    const context = canvas.getContext("2d"); //setcontext to 2d
  
    const frameCount = 7; //all image counts
